...
function EditBukuTeleponInternal() {
      ...
      <div className="space-y-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">
            Data buku telepon internal yang akan diedit tidak ditemukan.
          </p>
          <button
  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Edit Buku Telepon Internal</h1>
          <p className="text-gray-600">Edit kontak internal</p>
        </div>
        <button
...
export default EditBukuTeleponInternal;
